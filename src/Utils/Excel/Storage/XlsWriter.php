...
class XlsWriter extends BaseExcel implements ExcelInterface
{
    ...
    public function export(string $filename, array|\Closure $closure, ?\Closure $callbackData = null): ResponseInterface
    {
        ...
        $response = su_admin_container()->get(SuAdminResponse::class);
        ...
        if (copy($filePath, 'php://output') === false) {
            throw new SuAdminException('导出数据失败', 500);
        }
